...
bigint solve(int n) {
    ...
    if (n % 2 == 0) {
        solve(n / 2);
        dp[n][0][0] = dp[n/2][0][0] * dp[n/2][1][0] + dp[n/2][0][1] * (dp[n/2][0][0] + dp[n/2][1][0]);
        dp[n][1][0] = dp[n/2][1][0] * dp[n/2][1][0] + dp[n/2][1][1] * (dp[n/2][0][0] + dp[n/2][1][0]);
        dp[n][0][1] = dp[n][1][0];
        dp[n][1][1] = dp[n/2][1][0] * dp[n/2][1][1] + dp[n/2][1][1] * (dp[n/2][0][1] + dp[n/2][1][1]);

    }
    else {
        solve(n - 1);
        dp[n][0][0] = dp[n-1][0][1];
        dp[n][0][1] = dp[n-1][0][0] + dp[n-1][0][1];
        dp[n][1][0] = dp[n-1][1][1];
        dp[n][1][1] = dp[n-1][1][0] + dp[n-1][1][1];
